...
import static com.cydeo.utilities.SpartanNewBase.requestSpec;
import static com.cydeo.utilities.SpartanNewBase.responseSpec;
...
//        These parts are repeating in request specification
...
//                .log().all();
//
//        These parts are repeating in response specification
//        ResponseSpecification responseSpec = expect().statusCode(200)
//                .and()
//                .contentType(ContentType.JSON)
//                .logDetail(LogDetail.ALL);  //logging with response specification

//        If your code is repeating, make it reusable

        given().
                spec(requestSpec) //I replace my variable with requestSpec
                .when()
                .get("/spartans")
                .then()
                .spec(responseSpec); //I replace my variable with requestSpec
    }
