...
public class ParameterizedTesInJunit5 {
    @ParameterizedTest
    @ValueSource(ints = {1,3,5,6,7,9,10,5,21,32})   // assume there is a loop here
    public void testMultipleNumbers(int number){    // we pass each number here to this parameter
